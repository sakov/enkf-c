...
[EnKF-C](https://github.com) provides a compact, model-agnostic generic framework for off-line data assimilation into large-scale layered geophysical models using the ensemble Kalman filter.
...
1. Download the modified indent tool configuration: [indent-2.2.8a-mod.tar.gz](https://github.com/releases/download/data/indent-2.2.8a-mod.tar.gz "sakov/enkf-c Release Component")
