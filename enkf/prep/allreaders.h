...
typedef void (*obsread_fn) (char* fname, obsmeta* meta, model* m, observations* obs);
...
void reader_windsat_standard(char* fname, obsmeta* meta, model* m, observations* obs);
void reader_cars_standard(char* fname, obsmeta* meta, model* m, observations* obs);
