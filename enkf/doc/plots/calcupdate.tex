...
\node (add21) [circle, transparent, minimum width = 2.5cm, above = 1cm of ensobs] {CALC};
...
\draw[->, dotted] (jointG) to ([out = 90, in = 90, xshift = 3mm] transforms.south);
\node (add21) [circle, draw, fill = white, minimum width = 2.5cm, above = 1cm of ensobs] {CALC};
\draw[-, thick] (obs) to [out = 90, in = 180] (add21);
