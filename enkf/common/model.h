...
int model_getmemberfname_async(model* m, char dir[], char alias[], char varname[], int mem, int time, char fname[]);
void model_getbgfname(model* m, char dir[], char varname[], char fname[]);
void model_getspreadfname(model* m, char varname[], char fname[]);
int model_getbgfname_async(model* m, char dir[], char alias[], char varname[], int time, char fname[]);
